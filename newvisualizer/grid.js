  //scripts for grid 
    //<script src="audio_ref2.js"></script>
    //<script src = "audio_usr2.js"></script>
    ...
    columns = [
        ...
        {id: "Created Time", name: "Created Time", field: "Created Time", width: 200, editor: Slick.Editors.Date},
...
if(i ==2)
{
  ...
  function DetectSelection(){
    ...
    var k = 0;
     ...
     var refrecordingname = document.getElementById("ref_name");
     var usrrecordingname = document.getElementById("usr_name");

     refrecordingname.innerHTML = "reference recording:"+ refname + ", <br/>url:" + refurl;
     usrrecordingname.innerHTML = "My Recording:"+ usrsongname + ", <br/>url:" + usrurl;


     //loadmusic(songlisturl, songlistname, refurl,refname);
