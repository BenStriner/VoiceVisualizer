...
{
      d["Graph"] = (i== 0);
      d["Recording List"] = "Recording_Reference";
      d["URL"] = "arpeggio_Good.mp3";
...
{
      d["Graph"] = (i ==1);
      d["Recording List"] = "Recording_1";
      d["URL"] = "arpeggio_Bad.mp3";
      d["Created Time"] = "01/" + (10-i) +"/2013";
      //d["effortDriven"] = (i  == 0);
}
if(i ==2)
